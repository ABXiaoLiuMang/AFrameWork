...
public interface RouterHub {
     ...
     * 组名
     */
    String APP = "/demo";//宿主 App
    String JAVA = "/java";//组件
    String KOTLIN = "/kotin";//组件
     ...
     * 测试路由
     */
    String JAVA_SERVICE_GANKINFOSERVICE = JAVA + SERVICE + "/JavaInfoService";
    String JAVA_HOMEACTIVITY = JAVA + "/JavaActivity";
    String JAVA_TESTMJAVACTIVITY = JAVA + "/TestMjavActivity";

    String KOTLIN_SERVICE_KTINFOSERVICE = KOTLIN + SERVICE + "/KTInfoService";
    String KOTLIN_DEMOACTIVITY = KOTLIN + "/KtActivity";
    String KOTLIN_TESTMVPKTACTIVITY = KOTLIN + "/TestMvpKTActivity";
