...
/**
 * ================================================
 * 可通过 {@link CommonUtils#obtainAppComponentFromContext(Context)} 拿到此接口的实现类
 * 拥有此接口的实现类即可调用对应的方法拿到 Dagger 提供的对应实例
 * ================================================
 */
@Singleton
@Component(modules = {AppModule.class, ClientModule.class, DBModule.class, GlobalConfigModule.class})
