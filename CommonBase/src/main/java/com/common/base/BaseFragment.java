 ...
 * ================================================
 */
public abstract class BaseFragment<P extends IPresenter> extends Fragment implements IFragment, FragmentLifecycleable, ISupportFragment, ISwipeBackFragment {
    ...
    /**
     * 留意create 要使用 attachToSwipeBack
     * @param view
     * @return
     */
    @Override
