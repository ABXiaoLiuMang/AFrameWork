package com.test1.mvp.ui.fragment;
...
public class TestMjavFragment extends BaseFragment<TestMjavPresenter> implements TestMjavContract.View {

    public static TestMjavFragment newInstance() {
        TestMjavFragment fragment = new TestMjavFragment();
        return fragment;
    }
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_test_mjav, container, false);

        view.findViewById(R.id.btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                start(TestMjavFragment.newInstance());
            }
        });
